...
liker.addEventListener('click',function(){
	if (imgact==1) {
	liker.style.color="rgb(200,20,20)";
	imgact=0;
}
else{
	liker.style.color="";
...
var songlist=[{
	...
	},
	{
		...
		name: "Fireboy_Ft_Ed-Sheeran_Peru",
...
/* navigation effect */
    var navigat=document.querySelectorAll('.more-text');
    for(let n=0;n<navigat.length;n++){
    	navigat[n].addEventListener('click',function(){
    		 for(let n2=0;n2<navigat.length;n2++){
    		 	navigat[n2].removeAttribute('id','active');
    		 }
    		navigat[n].setAttribute('id','active');
    	})
    }
    var index=0;
    /* music-down effect */
...
searcher.addEventListener('mouseleave', function(){
